...
By default, Parity Ethereum runs a JSON-RPC HTTP server on port `:8293` and a Web-Sockets server on port `:8294`. This is fully configurable and supports a number of APIs.
